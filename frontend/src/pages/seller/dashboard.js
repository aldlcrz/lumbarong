...
import { ShoppingBag, Package, TrendingUp, AlertCircle, Clock, ShieldCheck, PlusCircle, Store, ArrowRight, Activity } from 'lucide-react';
            ...
            >
                ...
                {!user.isVerified && (
                    <motion.div
                        ...
                        className="bg-amber-50 border border-amber-200 p-6 rounded-[2rem] mb-8 flex items-start gap-4"
                    >
                ...
                <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100/50"
                    >
                            ...
                            <div className="space-y-4">
                                {stats.bestSellers.map((item, idx) => (
                                    <motion.div
                                        key={idx}
                                        whileHover={{ x: 5 }}
                                        className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl hover:bg-red-50 transition-all border border-transparent hover:border-red-100 group"
                                    >
                ...
                <motion.div variants={itemVariants} className="mt-12">
                    <section className="bg-white rounded-[3.5rem] p-10 lg:p-14 border border-gray-100 shadow-xl shadow-gray-200/50 relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-3xl font-black mb-2 text-gray-900 italic uppercase tracking-tighter">Artisan Registry Funnel</h2>
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                                ...
                                <div className="lg:w-1/3 grid grid-cols-1 gap-6 w-full">
                                    ...
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        className="p-6 bg-red-50/50 rounded-3xl border border-red-100 italic"
                                    >
...
function FunnelStep({ label, count, width, className, subtext, delay }) {
    return (
        <motion.div
        ...
        >
            <motion.div
                ...
                className={`p-6 rounded-3xl flex items-center justify-between shadow-lg transition-all ${className}`}
                style={{ width }}
            >
                <div>
...
function ConversionMetric({ label, rate }) {
    return (
        <motion.div
            whileHover={{ y: -5 }}
            className="bg-gray-50 p-6 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-all"
        >
...
function StatBox({ title, value, icon, color, loading, delay }) {
    return (
        <motion.div
            ...
            transition={{ delay }}
            whileHover={{ y: -10 }}
            className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 flex items-center justify-between group hover:shadow-xl transition-all h-full"
        >
            <div>
    ...
    return (
        <Link href={href}>
            <motion.div
                ...
                className="p-8 bg-white h-full rounded-[2.5rem] border border-gray-100 hover:border-red-600 hover:shadow-2xl hover:shadow-red-900/5 group transition-all cursor-pointer flex flex-col"
            >
                ...
                <p className="text-sm text-gray-500 font-medium italic opacity-70 mb-6 flex-1">{description}</p>
                <div className="flex items-center gap-2 text-red-600 font-black text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                    Access Workshop <ArrowRight size={12} />
                </div>
            </motion.div>
        </Link>
    );
